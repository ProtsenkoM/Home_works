...
class Gorilla(Primates):
    ...
    def __repr__(self):
        return f"Gorilla('{self.name}', '{self.species}', {self.age}, '{self.Characteristic_Feature}', '{self.Diet}', {self.tail}, {self.climb_trees}, '{self.color}', {self.weight_kg})"
